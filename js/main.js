...
$(document).ready(function () {
  ...
  fetch("https://api.github.com/orgs/dan-divy/members").then(res => res.json()).then(members => {
    document.getElementById("devs").innerHTML = members.map(m => `
    ...
    <div class="item-wrapper">
      ...
      <div class="legend">
        <h3 class="title">${m.login}</h3>
        <h4>${m.id == 41877062 || m.id == 34997667 ? 'Co-Founder' : 'Member'}</h4>
        <div class="icons">
          <a
            class="icon-btn"
            href="${m.html_url}"
